...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Water leak status", endpointType.iasSensor);
    var leak = endpoints.addEndpoint("3", "Water leak times", endpointType.genericSensor);
    leak.variableTypeId = 1286;
    var last = endpoints.addEndpoint("4", "Last duration", endpointType.genericSensor);
    last.variableTypeId = 1286;
